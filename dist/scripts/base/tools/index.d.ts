import idModifier from './id-modifier/id-modifier';
import temporaryFocus from './temporary-focus/temporary-focus';
import TokenList from './token-list/token-list';
declare const _default: {
    idModifier: typeof idModifier;
    PromiseRequest: (url: string, method?: "GET" | "POST") => Promise<unknown>;
    storage: import("./storage/storage").StorageArgs;
    temporaryFocus: typeof temporaryFocus;
