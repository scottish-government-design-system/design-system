...
class Tabs {
    constructor(tabContainer) {
        ...
        this.tabHeaders = [].slice.call(tabContainer.querySelectorAll('.mg_tab__header'));
    ...
    initTab(tabHeader, index) {
        const tabLabel = tabHeader.querySelector('.mg_tab__label');
    ...
    activateTab(targetTabHeader) {
        this.tabHeaders.forEach(tabHeader => {
            ...
            if (tabHeader === targetTabHeader) {
                tabHeader.classList.add('ds_current');
                tabHeader.querySelector('.mg_tab__label').setAttribute('aria-selected', true);
                tabContent.removeAttribute('hidden');
            } else {
                tabHeader.classList.remove('ds_current');
                tabHeader.querySelector('.mg_tab__label').setAttribute('aria-selected', false);
                tabContent.setAttribute('hidden', 'hidden');
            }
        });
