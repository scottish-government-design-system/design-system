            ...
            summaryListActions.forEach(actions => {
                ...
                actionButtons.forEach(actionButton => {
                    ...
                    if(!!actionButton.getAttribute('aria-describedby')){
                        ...
                        questionText = '-'+slugify(question.textContent);
                    }
                    actionButton.setAttribute('data-button', `button-${slugify(actionButton.textContent)}${questionText}`);
                });
                actionLinks.forEach(actionLink => {
                    let questionText = '';
                    ...
                    actionLink.setAttribute('data-navigation', `navigation-${slugify(actionLink.textContent)}${questionText}`);
                });
            });
        },
